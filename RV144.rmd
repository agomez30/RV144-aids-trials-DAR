...
```
  ...
  We would expectto see both graphs of equal size (50% on each side) if the two are independent.  They do not appear to be equal, shedding doubt on the idea of independence.
...
```
  ...
  The p-value of 0.0482 means the probability of getting a result like that just obtained if the null hypothesis is true is approximately 4 percent.  This is  normally considered significant.  
